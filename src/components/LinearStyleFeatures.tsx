      ...
      <div className="relative w-full px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-400 animate-fade-in max-w-3xl mx-auto leading-relaxed" style={{
            ...
            SquadAssist is shaped by the practices and principles that distinguish world-class football clubs from the rest: relentless focus, fast execution, and a commitment to the quality of transfers.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-8 hover:bg-gray-900/70 transition-all duration-500 animate-fade-up group"
              style={{
