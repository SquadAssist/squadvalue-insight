    ...
    <section id="how-it-works" className="py-20 bg-blue-50">
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          {/* On Field Value */}
          <div 
            className="flex flex-col items-center text-center p-8 bg-white rounded-xl shadow-md animate-fade-up border border-blue-100 hover:shadow-lg transition-all duration-300"
