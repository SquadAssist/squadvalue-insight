      ...
      <div className="container px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600 animate-fade-up" style={{ animationDelay: "200ms" }}>
            SquadAssist combines advanced AI with deep football knowledge to transform how clubs approach the transfer market.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="bg-white p-6 rounded-xl shadow-subtle border border-gray-100 feature-card-hover animate-fade-up"
